...
public:
  ...
  PageSender(DataChannel &Channel, PageSource &Source, uint64_t TagBase, StreamGeometry G, bool FlipOneBit = false, bool Verify = true,
             Sum Which = Sum::XxH3)
      : Channel(Channel), Source(Source), TagBase(TagBase), G(G), FlipOneBit(FlipOneBit), Whole(Verify, Which) {}
